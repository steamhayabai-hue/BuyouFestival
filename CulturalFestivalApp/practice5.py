...
# 3 後でログイン認証用のuserデータ
users = {"myagmyag": "banpakusaiko1", "yamagisi2": "pass2"}

# 4 後でクラス企画のclass_projectデータ
# クラス企画情報（クラス名：企画名, 概要, 詳細, 画像）
class_project = {
    "1年4組": ["お化け屋敷", "お化け屋敷！ドキドキの体験をお楽しみください。", "暗い教室の中で、本格的な演出と仕掛けが満載のお化け屋敷を体験できます。", ""],
    "2年4組": ["カフェ", "カフェ☕️でゆったりと休憩しませんか？", "手作りスイーツとドリンクを提供する、落ち着いた空間のカフェです。", "/Users/steam05/Desktop/R0001434.jpg.webp"],
    "3年4組": ["縁日屋台", "縁日風屋台！射的やヨーヨー釣りもあります。", "日本の伝統的な縁日を再現した屋台で、楽しいゲームや景品が盛りだくさん。", "images/class_3_1.jpg"],
    "図書室": ["武将フェア", "武将フェア開催！ゆかりの文書を辿ろう。", "戦国武将に関する書籍や展示を集めたフェア。解説パネルも充実。", "images/class_3_1.jpg"],
    "音楽室": ["音楽フェス", "軽音楽部による音楽フェス！熱く盛りあがろう。", "校内バンドやゲストが出演する音楽イベント。手拍子・声援大歓迎！", "/Users/steam05/Desktop/club_thumb_ph24.jpg"],
    "図工室": ["ものづくり体験", "廃材を使った日曜大工、フライパン製作", "工具を使って本格的なDIYが体験できます。お土産に持ち帰り可能。", "/Users/steam05/Desktop/DSCN1099.JPG"],
    "家庭科室": ["お菓子教室", "お菓子作り教室！美味しいクッキーの焼き方を伝授", "家庭科部監修のお菓子作り体験。レシピ付きで自宅でも再現OK。", "/Users/steam05/Desktop/unnamed.jpg"],
    "理科室": ["ハピエネ", "空気砲を作ろう！その他電流による実験もあります。", "科学部による体験型の実験展示。安全で楽しい実験がいっぱい。", "/Users/steam05/Desktop/science_room.jpg"],
    "トイレ": ["トイレ", "お手洗いはこちら", "校内の各階に配置されています。安心してご利用ください。", "/Users/steam05/Desktop/20191118-12-02-451x302.jpg"]
}
...
def map_page():
    ...
    # 6 後でオーバーレイ画像の作成
    st.image("/Users/steam05/Desktop/facilities2023.png", use_column_width=True)
...
room_locations = {
    "クラス":{
        "１年４組":{(945,600,1025,670)},
        "２年４組":{(865,600,945,670)},
        "３年４組":{(160,220,220,260)},
    },
    "特別教室":{
        "図書室":{(600,60,680,100)},
        "音楽室":{(960,60,1050,100)},
        "図工室":{(480,230,560,270)},
        "家庭科室":{(560,230,880,270)},
        "理科室":{(800,340,880,270)},
        "トイレ":[
